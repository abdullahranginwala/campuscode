...
>("/signup", async (req, res) => {
    try {
        ...
        const token = jwt.sign(user.username, "3a7f69bfb570e498d6e2f4775af5c98c8e7e94c9b0a1a3a39e0df5f394b127e82"!);
    ...
    try {
        ...
        if (await bcrypt.compare(password, user.password)) {
            const token = jwt.sign(
                user.username,
                "3a7f69bfb570e498d6e2f4775af5c98c8e7e94c9b0a1a3a39e0df5f394b127e82"!
            );
